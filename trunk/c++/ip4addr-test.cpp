...
void IP4AddrTest::goodint_goodplen24(void)
{
...
void IP4AddrTest::goodint_goodstr24(void)
{
...
void IP4AddrTest::goodint_goodint24(void)
{
...
void IP4AddrTest::badstr_goodplen24(void)
{
    IP4Addr::IP4Addr addr("1", 24);
    invalid_addr(addr);
}

void IP4AddrTest::goodstr_badmask(void)
{
    IP4Addr::IP4Addr addr("1.1.1.1", 64);
    invalid_addr(addr);
}

void IP4AddrTest::goodstr_goodplen_default(void)
{
...
void IP4AddrTest::goodstr_goodplen_hostroute(void)
{
...
void IP4AddrTest::goodstr_badplen_toohigh(void)
{
    IP4Addr::IP4Addr addr("192.168.1.1", 33);
    invalid_addr(addr);
}

void IP4AddrTest::goodstr_badsnmask_toohigh(void)
{
    IP4Addr::IP4Addr addr("192.168.1.1", 4294967293U);
    invalid_addr(addr);
}

void IP4AddrTest::goodstr_goodplen30(void)
{
...
void IP4AddrTest::goodstr_badmask_nbo8(void)
{
